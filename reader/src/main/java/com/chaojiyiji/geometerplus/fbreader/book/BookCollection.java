...
package com.chaojiyiji.geometerplus.fbreader.book;

import java.io.File;
import java.util.*;

import com.chaojiyiji.geometerplus.zlibrary.core.filesystem.*;
...
public class BookCollection extends AbstractBookCollection<DbBook> {
	...
	public BookCollection(SystemInfo systemInfo, BooksDatabase db, List<String> bookDirectories) {
		...
		PluginCollection = com.chaojiyiji.geometerplus.fbreader.formats.PluginCollection.Instance(systemInfo);
		myDatabase = db;
