...
package com.chaojiyiji.geometerplus.fbreader.network.authentication.litres;

import java.util.*;

import com.chaojiyiji.geometerplus.zlibrary.core.util.MimeType;
import com.chaojiyiji.geometerplus.zlibrary.core.xml.*;
...
import com.chaojiyiji.geometerplus.fbreader.network.opds.OPDSNetworkLink;
import com.chaojiyiji.geometerplus.fbreader.network.atom.FormattedBuffer;
			...
			case BOOK:
				if (TAG_BOOK == tag) {
					myUrls.addInfo(new UrlInfo(
						...
						"http://data.fbreader.com.chaojiyiji/catalogs/litres2/full.php5?id=" + myBookId,
