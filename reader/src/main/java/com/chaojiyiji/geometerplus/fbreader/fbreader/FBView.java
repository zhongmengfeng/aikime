...
import com.chaojiyiji.geometerplus.zlibrary.core.filesystem.ZLResourceFile;
import com.chaojiyiji.geometerplus.zlibrary.core.fonts.FontEntry;
...
import com.chaojiyiji.geometerplus.zlibrary.core.view.SelectionCursor;
import com.chaojiyiji.geometerplus.zlibrary.core.view.ZLPaintContext;

import com.chaojiyiji.geometerplus.zlibrary.text.model.ZLTextModel;
...
import com.chaojiyiji.geometerplus.fbreader.bookmodel.FBHyperlinkType;
import com.chaojiyiji.geometerplus.fbreader.bookmodel.TOCTree;
...
//		}
		...
		// 关闭选择菜单
		if(myReader.isActionVisible(ActionCode.SELECTION_SHOW_PANEL)){
