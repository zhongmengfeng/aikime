...
import com.chaojiyiji.geometerplus.zlibrary.text.model.ZLTextMark;
...
//	private int myModelIndex;
	...
	public ZLTextWordCursor(ZLTextParagraphCursor myParagraphCursor, int myElementIndex, int myCharIndex){
