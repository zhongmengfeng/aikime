...
package com.chaojiyiji.geometerplus.android.fbreader.error;
...
import com.chaojiyiji.geometerplus.zlibrary.ui.android.error.ErrorUtil;
import com.chaojiyiji.geometerplus.android.fbreader.util.SimpleDialogActivity;
	...
	protected void onCreate(Bundle bundle) {
		...
		okButton().setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "issues@fbreader.com.chaojiyiji" });
