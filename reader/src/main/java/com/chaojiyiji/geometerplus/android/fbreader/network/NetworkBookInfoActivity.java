...
package com.chaojiyiji.geometerplus.android.fbreader.network;
...
import com.chaojiyiji.geometerplus.zlibrary.core.image.ZLImageProxy;
...
import com.chaojiyiji.geometerplus.zlibrary.ui.android.image.ZLAndroidImageData;
import com.chaojiyiji.geometerplus.zlibrary.ui.android.image.ZLAndroidImageManager;
import com.chaojiyiji.geometerplus.zlibrary.ui.android.network.SQLiteCookieDatabase;

import com.chaojiyiji.geometerplus.fbreader.network.*;
import com.chaojiyiji.geometerplus.fbreader.network.opds.OPDSBookItem;
import com.chaojiyiji.geometerplus.fbreader.network.tree.NetworkBookTree;
import com.chaojiyiji.geometerplus.fbreader.network.urlInfo.RelatedUrlInfo;
...
import com.chaojiyiji.geometerplus.android.fbreader.network.action.NetworkBookActions;
import com.chaojiyiji.geometerplus.android.fbreader.network.action.OpenCatalogAction;
import com.chaojiyiji.geometerplus.android.fbreader.network.auth.ActivityNetworkContext;
import com.chaojiyiji.geometerplus.android.fbreader.util.AndroidImageSynchronizer;
import com.chaojiyiji.geometerplus.android.util.*;
...
public class NetworkBookInfoActivity extends Activity implements NetworkLibrary.ChangeListener {
	...
	protected void onCreate(Bundle icicle) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new com.chaojiyiji.geometerplus.zlibrary.ui.android.library.UncaughtExceptionHandler(this));
