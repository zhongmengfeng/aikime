...
import com.chaojiyiji.geometerplus.fbreader.library.*;
import com.chaojiyiji.geometerplus.fbreader.tree.FBTree;

import com.chaojiyiji.geometerplus.android.util.*;
import com.chaojiyiji.geometerplus.android.fbreader.*;
...
public class LibraryActivity extends TreeActivity<LibraryTree> implements MenuItem.OnMenuItemClickListener, View.OnCreateContextMenuListener, IBookCollection.Listener<Book> {
	...
	private void runOrInstallExternalView(boolean install) {
		try {
			...
			if (install) {
				PackageUtil.installFromMarket(this, "com.chaojiyiji.fbreader.plugin.library");
			}
		}
	}
