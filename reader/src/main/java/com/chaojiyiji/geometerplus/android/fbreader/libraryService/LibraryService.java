...
package com.chaojiyiji.geometerplus.android.fbreader.libraryService;
...
import com.chaojiyiji.geometerplus.zlibrary.text.view.ZLTextPosition;
...
import com.chaojiyiji.geometerplus.android.fbreader.httpd.DataUtil;
...
public class LibraryService extends Service {
	...
	public IBinder onBind(Intent intent) {
		Log.e("LibraryService", "LibraryService onBind");
		return myLibrary;
	}
	...
	public void onDestroy() {
		Log.e("LibraryService", "LibraryService onDestroy");
