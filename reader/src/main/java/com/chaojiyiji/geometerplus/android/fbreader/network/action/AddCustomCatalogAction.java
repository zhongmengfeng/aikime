...
import com.chaojiyiji.geometerplus.fbreader.network.tree.RootTree;
import com.chaojiyiji.geometerplus.fbreader.network.tree.AddCustomCatalogItemTree;

import com.chaojiyiji.geometerplus.android.fbreader.network.AddCatalogMenuActivity;
...
public class AddCustomCatalogAction extends Action {
	...
	public void run(NetworkTree tree) {
		myActivity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://data.fbreader.com.chaojiyiji/add_catalog"), myActivity, AddCatalogMenuActivity.class));
	}
}
