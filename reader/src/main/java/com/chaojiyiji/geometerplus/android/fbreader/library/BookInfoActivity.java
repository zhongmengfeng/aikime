...
package com.chaojiyiji.geometerplus.android.fbreader.library;
...
import com.chaojiyiji.geometerplus.zlibrary.core.filesystem.ZLPhysicalFile;
...
import com.chaojiyiji.geometerplus.zlibrary.core.language.ZLLanguageUtil;
...
import com.chaojiyiji.geometerplus.fbreader.network.HtmlUtil;
...
import com.chaojiyiji.geometerplus.android.fbreader.preferences.EditBookInfoActivity;
...
public class BookInfoActivity extends Activity implements IBookCollection.Listener<Book> {
	...
	protected void onCreate(Bundle icicle) {
		...
		Thread.setDefaultUncaughtExceptionHandler(
			new com.chaojiyiji.geometerplus.zlibrary.ui.android.library.UncaughtExceptionHandler(this)
		);
