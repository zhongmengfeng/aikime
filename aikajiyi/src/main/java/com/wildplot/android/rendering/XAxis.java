...
public class XAxis implements Drawable {
	...
	private void drawMarkers(GraphicsWrap g) {
		...
		float oldSize = g.getFontSize();//为修改恭喜完成页面图表的x轴名字字体大小添加此代码
		g.setFontSize(oldSize * 2.0f);//为修改恭喜完成页面图表的x轴名字字体大小添加此代码
	...
	private void drawNumbering(GraphicsWrap g, RectangleWrap field, double x, int index) {
		...
		float oldSize = g.getFontSize();//为修改恭喜完成页面图表的x轴刻度数字的字体大小添加此代码
		g.setFontSize(oldSize * 2.0f);//为修改恭喜完成页面图表的x轴刻度数字的字体大小添加此代码
		...
		g.setFontSize(oldSize);//为修改恭喜完成页面图表的x轴刻度数字的字体大小添加此代码
	}
