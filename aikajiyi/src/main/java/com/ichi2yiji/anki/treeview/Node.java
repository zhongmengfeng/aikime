...
public class Node
{
	...
	public Node(int id, int pId, String name, String depth, String did, String lrnCount, String newCount, String revCount, SlideView slideView)
	{
		super();
		this.id = id;
		this.pId = pId;
	...
	public String getLrnCount() {
		return lrnCount;
	}

	public void setLrnCount(String lrnCount) {
		this.lrnCount = lrnCount;
	}
