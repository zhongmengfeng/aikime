...
import com.chaojiyiji.geometerplus.android.fbreader.FBReaderApplication;
import com.chaojiyiji.yiji.BuildConfig;
import com.chaojiyiji.yiji.R;
import com.ichi2yiji.anki.dialogs.AnkiDroidCrashReportDialog;
...
import com.ichi2yiji.utils.LanguageUtil;
...
public class AnkiDroidApp extends FBReaderApplication {
     ...
     */
    private boolean isOfficeNet = false;
    ...
    public static HashMap<String, Activity> activityManager;
    ...
    public void onCreate() {
        ...
        //**************************************************//
        x.Ext.init(this);
        x.Ext.setDebug(AnkiDroidApp.isDebug); // 是否输出debug日志
        LogUtil.e("onCreate: BuildConfig.DEBUG = " + BuildConfig.DEBUG);
        //****************************************************//
        ...
        if (CollectionHelper.hasStorageAccessPermission(this)) {
            try {
                ...
                Log.e("CollectionHelper","dir>>>>>>>>>>>>>>>>>>>" + dir);
...
//            BASE_DOMAIN = "https://www.ankichina.net/";//外网
