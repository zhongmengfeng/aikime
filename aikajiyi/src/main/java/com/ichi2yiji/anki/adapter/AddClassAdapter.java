...
public class AddClassAdapter extends BaseAdapter {
    ...
    private List<SharedDecksBean.DataBean.ClassCreatedByMeBean.DecksBean> list;
    ...
    public AddClassAdapter(Context context, List<SharedDecksBean.DataBean.ClassCreatedByMeBean.DecksBean> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //SharedDecksBean.DataBean.ClassCreatedByMeBean classCreatedByMeBean = list.get(position);
        SharedDecksBean.DataBean.ClassCreatedByMeBean.DecksBean decksBean = list.get(position);
    ...
    public interface ItemDownClicklistener{
         void itemdownclicklistener(View view,int position);
    }
    class ViewHolder{
