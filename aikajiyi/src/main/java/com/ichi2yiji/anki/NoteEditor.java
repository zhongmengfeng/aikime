...
import com.ichi2yiji.anki.dialogs.NoteEditorRescheduleCard;
...
import com.ichi2yiji.anki.multimediacard.fields.EFieldType;
...
import com.ichi2yiji.anki.multimediacard.impl.MultimediaEditableNote;
...
//    public static final String TARGET_LANGUAGE = "TARGET_LANGUAGE";
        ...
        if (mAddNote) {
            ...
            if (!newModel.equals(oldModel)) {
                ...
                if (mModelChangeCardMap.size() < mEditorNote.cards().size() || mModelChangeCardMap.containsKey(null)) {
                    ...
                    bundle.putString("message", res.getString(R.string.confirm_map_cards_to_nothing));
                    bundle.putString("title", "");
                    ConfirmationDialog c = ConfirmationDialog.newInstance(bundle);
                    c.setRunConfirmation(new Runnable() {
                        @Override
                        public void run() {
    ...
    private void changeNoteTypeWithErrorHandling(final JSONObject oldModel, final JSONObject newModel) {
        ...
        try {
            ...
            Bundle bundle = new Bundle();
            bundle.putString("message", res.getString(R.string.full_sync_confirmation));
            bundle.putString("title", "");
            ConfirmationDialog c = ConfirmationDialog.newInstance(bundle);
            c.setRunConfirmation(new Runnable() {
                @Override
