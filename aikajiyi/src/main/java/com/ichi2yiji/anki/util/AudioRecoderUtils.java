...
public class AudioRecoderUtils {
    ...
    public void startRecord() {
        ...
        try {
            ...
            filePath = FolderPath+format_time+ ".amr" ;
            /* ③准备 */
    ...
    public void startPlayer(String filePath){
        ...
        if (file.exists()) {
            try {
                ...
                Log.e(TAG, "onClick: 播放录音开始");
            } catch (IOException e) {
                Log.e(TAG, "onClick: 播放录音失败", e);
            }
        } else {
            Log.e(TAG, "onClick: 没有录音文件");
        }
    ...
    public String getVoiceInfo(){
        if (mMediaPlayer != null) {
            int milliseconds = mMediaPlayer.getDuration();
            String info=String.valueOf(milliseconds);
