            ...
            if (direction != null) {
                ...
                switch (direction) {
                    ...
                    case BOTTOM:
                        ...
                        guideViewParams.setMargins(offsetX, bottom + offsetY, -offsetX, -bottom);
                        break;
                    case RIGHT:
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (myShape != null) {
            ...
            switch (myShape) {
                ...
                case ELLIPSE://椭圆
                    //RectF对象
                    oval.left = center[0] - 80;                              //左边
                    oval.top = center[1] - 44;                                   //上边
                    oval.right = center[0] + 120;                             //右边
                    oval.bottom = center[1] + 44;                                //下边
                    temp.drawOval(oval, mCirclePaint);                   //绘制椭圆
                    break;
                case RECTANGULAR://圆角矩形
                    //RectF对象
                    oval.left = center[0] - 240;                              //左边
                    oval.top = center[1] - 50;                                   //上边
                    oval.right = center[0] + 240;                             //右边
