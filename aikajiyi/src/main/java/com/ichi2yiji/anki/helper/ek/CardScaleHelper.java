package com.ichi2yiji.anki.helper.ek;
...
//                TLog.log(String.format("dx=%s, dy=%s, mScrolledX=%s", dx, dy, mCurrentItemOffset));
                Log.e(TAG, "onScrolled: " + String.format("dx=%s, dy=%s, mScrolledX=%s", dx, dy, mCurrentItemOffset));
    ...
    private void initWidth() {
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                mCardWidth = mCardGalleryWidth - DisplayUtils.dip2px(mContext, 2 * (mPagePadding + mShowLeftCardWidth));
...
//            TLog.log((String.format("=======onCurrentItemPos Changed======= tempPos=%s, mCurrentItemPos=%s", tempPos, mCurrentItemPos)));
            Log.e(TAG, "computeCurrentItemPos: " + String.format("=======onCurrentItemPos Changed======= tempPos=%s, mCurrentItemPos=%s", tempPos, mCurrentItemPos));
        }
    }
...
//        TLog.log((String.format("offset=%s, percent=%s", offset, percent)));
        Log.e(TAG, "onScrolledChangedCallback: " + String.format("offset=%s, percent=%s", offset, percent));
        View leftView = null;
        View currentView;
        View rightView = null;
