...
import com.ichi2yiji.anki.dialogs.CardBrowserContextMenu;
...
import com.ichi2yiji.anki.dialogs.TagsDialog.TagsDialogListener;
...
public class CardBrowser extends NavigationDrawerActivity implements
    ...
    protected void onCollectionLoaded(Collection col) {
        ...
        Log.e("CardBrowserActivity", "1111>>>>>>>"+ mCards.toString());
        Log.e("CardBrowserActivity", "1111>>>>>>>"+ mDeckNames.toString());
        Log.e("CardBrowserActivity", "1111>>>>>>>"+ mDropDownDecks.toString());
    }
    ...
    public void selectDropDownItem(int position) {
        Log.e("selectDropDownItem", "position>>>>>>>"+ String.valueOf(position));
    ...
    private DeckTask.TaskListener mSearchCardsHandler = new DeckTask.TaskListener() {
        ...
        public void onProgressUpdate(TaskData... values) {
            if (mCards != null && values[0]!= null) {
                ...
                updateList();
                Log.e("mSearchCardsHandler", "onProgressUpdate>>>mCards>>>>"+ mCards.toString());
            }
        }
        ...
        public void onPostExecute(TaskData result) {            
            if (result != null && mCards != null) {
                ...
                Log.e("mSearchCardsHandler", "onPostExecute>>>mCards>>>>"+ mCards.toString());
            }
            hideProgressBar();
        }
    ...
    private DeckTask.TaskListener mRenderQAHandler = new DeckTask.TaskListener() {
        ...
        public void onPostExecute(TaskData result) {
            ...
            Log.e("mRenderQAHandler", "onPostExecute>>>>mCards>>>"+ mCards.toString());
        }
    ...
    private final class RenderOnScroll implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            Log.e("CardBrowserActivity", "onScroll>>>>mCards>>>"+ mCards.toString());
        }
        ...
        public void onScrollStateChanged(AbsListView listView, int scrollState) {
            ...
            Log.e("CardBrowserActivity", "onScrollStateChanged>>>mCards>>>>"+ mCards.toString());
        }
    }
    ...
    private final class MultiColumnListAdapter extends BaseAdapter {
        ...
        public MultiColumnListAdapter(Context context, ArrayList<HashMap<String, String>> data, int resource,
            ...
            Log.e("colorFlagKey",colorFlagKey);
        }
    ...
    private ArrayList<HashMap<String, String>> getCards() {
        ...
        Log.e("CardBrowserActivity", "3333>>>>>>>"+ mCards.toString());
        return mCards;
    }
