 ...
 * 艾卡共享
 */
public class DownLoadDecks_new extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) throws SQLException {
        ...
        svProgressHUD = new SVProgressHUD(DownLoadDecks_new.this);
        initWebView();
        //  获取基本数据
        requestData();
    }
            ...
            public void onFinished() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        DownLoadDecks_new.this.finish();
                        DownLoadDecks_new.this.overridePendingTransition(R.anim.in_new_activity_translate_anim,R.anim.out_old_activity_translate_anim);
