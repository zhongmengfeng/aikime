...
import com.ichi2yiji.anki.CongratulationActivity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                String data_from_REVIEW_COUNT = SPUtil.getPreferences(SPUtil.TYPE_DEFAULT_CONFIG, "REVIEW_COUNT", "");
                String data_from_TODAYSTATS = SPUtil.getPreferences(SPUtil.TYPE_DEFAULT_CONFIG, "TODAYSTATS", "");
...
//        return inflater.inflate(R.layout.fragment_congratulation, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (count == 5){
            ...
            count = 0;
            SPUtil.setPreferences(SPUtil.TYPE_DEFAULT_CONFIG, "LearningOverDeckNumber",count);
        }

        //获取当前牌组复习计数数据并绘制原生ChartView（REVIEW_COUNT）
        // 原生报表(暂时不用,使用webView展示报表)
