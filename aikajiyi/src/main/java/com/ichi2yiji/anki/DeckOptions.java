...
import com.ichi2yiji.preferences.StepsPreference;
...
public class DeckOptions extends AppCompatPreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    protected void buildLists() {
        ...
        Log.e("DeckOptions","confLabels>>>>>>>>>>>>>" + Arrays.toString(confLabels));
        Log.e("DeckOptions","confValues>>>>>>>>>>>>>" + Arrays.toString(confValues));
    ...
    private void restartActivity() {
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            //dx  add
            //(R.anim.in_new_activity_translate_anim, R.anim.out_old_activity_translate_anim);
            overridePendingTransition(0, 0);
        }
    }
}
