...
public class StudyOptionsFragment extends Fragment implements Toolbar.OnMenuItemClickListener {
    ...
    private void closeStudyOptions(int result) {
        ...
        if (!mFragmented && a != null) {
            ...
            a.finish();
            //dx  add
            a.overridePendingTransition(R.anim.in_new_activity_translate_anim,R.anim.out_old_activity_translate_anim);
        ...
        return new DeckTask.TaskListener() {
            ...
            public void onPostExecute(DeckTask.TaskData result) {
                ...
                if (result != null) {
                    ...
                    // Don't do anything if the fragment is no longer attached to it's Activity or mCol has been closed
                    if (getActivity() == null) {
