 ...
 */
public class BottomMenuAdapter extends RecyclerView.Adapter<BottomMenuAdapter.TRMViewHolder> {
    private Context mContext;
    private List<MenuItem> menuItemList;
    private boolean showIcon;
    private BottomRightMenu mBottomRightMenu;
    private BottomRightMenu.OnMenuItemClickListener onMenuItemClickListener;

    public BottomMenuAdapter(Context context, BottomRightMenu bottomRightMenu, List<MenuItem> menuItemList, boolean show) {
        this.mContext = context;
        this.mBottomRightMenu = bottomRightMenu;
    ...
    public TRMViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.brm_item_popup_menu_list, parent, false);
    ...
    public void setOnMenuItemClickListener(BottomRightMenu.OnMenuItemClickListener listener){
