...
public class BottomRightMenu {
    ...
    public BottomRightMenu(Activity context) {
        this.mContext = context;
        init();
    }

    private void init() {
        content = LayoutInflater.from(mContext).inflate(R.layout.bottomright_popup_menu, null);
        mRecyclerView = (RecyclerView) content.findViewById(R.id.bottomright_recyclerview);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.VERTICAL, false));
        mRecyclerView.setOverScrollMode(View.OVER_SCROLL_NEVER);

        menuItemList = new ArrayList<>();
        mAdapter = new BottomMenuAdapter(mContext, this, menuItemList, showIcon);
    }
    ...
    public BottomRightMenu setHeight(int height){
    ...
    public BottomRightMenu setWidth(int width){
     ...
     * @return
     */
    public BottomRightMenu showIcon(boolean show){
        this.showIcon = show;
        return this;
    }
     ...
     * @return
     */
    public BottomRightMenu addMenuItem(MenuItem item){
     ...
     * @return
     */
    public BottomRightMenu addMenuList(List<MenuItem> list){
     ...
     * @return
     */
    public BottomRightMenu dimBackground(boolean b){
     ...
     * @return
     */
    public BottomRightMenu needAnimationStyle(boolean need){
     ...
     * @return
     */
    public BottomRightMenu setAnimationStyle(int style){
        this.animationStyle = style;
        return this;
    }

    public BottomRightMenu setOnMenuItemClickListener(OnMenuItemClickListener listener){
        mAdapter.setOnMenuItemClickListener(listener);
        return this;
    }

    public BottomRightMenu showAsDropDown(View anchor){
        showAsDropDown(anchor, 0, 0);
        return this;
    }

    public BottomRightMenu showAsDropDown(View anchor, int xoff, int yoff){
