...
import com.ichi2yiji.libanki.hooks.ChessFilter;
import com.ichi2yiji.libanki.hooks.HebrewFixFilter;
import com.ichi2yiji.libanki.hooks.Hooks;
import com.ichi2yiji.preferences.NumberRangePreference;
import com.ichi2yiji.themes.Themes;
import com.ichi2yiji.ui.AppCompatPreferenceActivity;
import com.ichi2yiji.ui.SeekBarPreference;
...
public class Preferences extends AppCompatPreferenceActivity implements PreferenceContext, OnSharedPreferenceChangeListener {
     ...
     * show answer
     */
    public static final String ANSWER_MODE = "mode";
        ...
        try {
            ...
            switch (key) {
                ...
                case "providerEnabled": {
                    ComponentName providerName = new ComponentName(this, "com.ichi2.anki.provider.YijiCardContentProvider");
