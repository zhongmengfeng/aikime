...
package com.ichi2yiji.anki.provider;
...
import com.ichi2yiji.anki.FlashCardsContract;
import com.ichi2yiji.anki.FlashCardsContract.CardTemplate;
 ...
 * </ul>
 */
public class YijiCardContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        Timber.d("YijiCardContentProvider: onCreate");
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Timber.d("YijiCardContentProvider.query");
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        Timber.d("YijiCardContentProvider.update");
        Collection col = CollectionHelper.getInstance().getCol(getContext());
        if (col == null) {
            return 0;
        }
            ...
            case NOTES_ID: {
                ...
                for (Map.Entry<String, Object> entry : valueSet) {
                    ...
                    if (key.equals(FlashCardsContract.Note.FLDS)) {
                        // Update FLDS
                        Timber.d("YijiCardContentProvider: flds update...");
                        ...
                        // Update tags
                        Timber.d("YijiCardContentProvider: tags update...");
                ...
                Timber.d("YijiCardContentProvider: Saving note...");
                currentNote.flush();
                break;
            }
            case NOTES_ID_CARDS:
...
//                break;
            case NOTES_ID_CARDS_ORD: {
                ...
                if ((isDeckUpdate) && (did >= 0)) {
                    Timber.d("YijiCardContentProvider: Moving card to other deck...");
                    col.getDecks().flush();
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        Timber.d("YijiCardContentProvider.delete");
        Collection col = CollectionHelper.getInstance().getCol(getContext());
        if (col == null) {
            return 0;
        }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        Timber.d("YijiCardContentProvider.insert");
        Collection col = CollectionHelper.getInstance().getCol(getContext());
        if (col == null) {
            return null;
        }
        ...
        switch (match) {
            case NOTES: {
                ...
                // Create empty note
                com.ichi2yiji.libanki.Note newNote = new com.ichi2yiji.libanki.Note(col, col.getModels().get(modelId));
                // Set fields
