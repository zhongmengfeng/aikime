...
//        plotSheet.setFrameThickness(mFrameThickness*0.66f, mFrameThickness*0.66f, mFrameThickness, mFrameThickness*0.9f);
        plotSheet.setFrameThickness(mFrameThickness*1.66f, mFrameThickness*1.66f, mFrameThickness, mFrameThickness*1.9f);//为修改恭喜完成页面图表的外边框的厚度修改此处，plotSheet、hiddenPlotSheet应同时修改成相同的值
        plotSheet.setFontSize(textSize);

        if(mChartType == Stats.ChartType.CARDS_TYPES){
            return createPieChart(plotSheet);//卡牌类型圆图
        }
...
//        hiddenPlotSheet.setFrameThickness(mFrameThickness*0.66f, mFrameThickness*0.66f, mFrameThickness, mFrameThickness*0.9f);
        hiddenPlotSheet.setFrameThickness(mFrameThickness*1.66f, mFrameThickness*1.66f, mFrameThickness, mFrameThickness*1.9f);//为修改恭喜完成页面图表的外边框的厚度修改此处，plotSheet、hiddenPlotSheet应同时修改成相同的值
...
//        setupGrid(plotSheet, yTicks*0.5, xTicks*0.5);
        setupGrid(plotSheet, yTicks, xTicks);//为修改恭喜完成页面图表的网格虚线疏密修改上一行代码
