...
import com.ichi2yiji.anki.IntentHandler;
import com.ichi2yiji.anki.features.splash.SplashActivity;
...
public class AnkiDroidWidgetSmall extends AppWidgetProvider {
    ...
    public static class UpdateService extends Service {
        ...
        private RemoteViews buildUpdate(Context context, boolean updateDueDecksNow) {
            ...
            Intent ankiDroidIntent = new Intent(context, SplashActivity.class);
